...
export function AttendanceRequestsPage() {
  ...
  const filteredRows = rows.filter((row) => statusFilter === 'all' || row[6] === statusFilter)
  return (
    <AppMain
                ...
                return (
                  <TableRow key={row[0]}>
                    ...
                    <TableCell>
                      <Badge
                        variant={
                          row[6] === 'pending' ? 'amber' : row[6] === 'rejected' ? 'red' : 'green'
                        }
                      >
                        {item[0]}
                      </Badge>
                    ...
                    <TableCell>
                      <Button size='sm' variant='ghost' asChild>
                        <Link to='/attendance/requests/$requestId' params={{ requestId: row[0] }}>
