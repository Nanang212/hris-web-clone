...
import { EmployeeStatusBadge } from '@/features/employment/components/employee-status-badge'
import {
  useGetEmployeeById,
                ...
                <>
                  <div>
                    ...
                    <InfoGrid>
                      ...
                      <InfoRow
                        label='Tanggal Lahir'
                        value={personal.birthDate ? dayjs(personal.birthDate).format('DD MMMM YYYY') : null}
                      />
                      <InfoRow
                        label='Jenis Kelamin'
              ...
              {employment ? (
                <>
                  <div>
                    ...
                    <InfoGrid>
                      <InfoRow
                        label='Tipe Kontrak'
                        value={
                          { permanent: 'Karyawan Tetap', contract: 'Kontrak', internship: 'Magang', freelance: 'Freelance' }[
                      ...
                      <InfoRow
                        label='Tanggal Mulai'
                        value={employment.contractStart ? dayjs(employment.contractStart).format('DD MMMM YYYY') : null}
                      />
                      <InfoRow
                  ...
                  <div>
                    ...
                    <InfoGrid>
                      <InfoRow label='No. BPJS Ketenagakerjaan' value={employment.bpjsKetenagakerjaanNo} />
                  ...
                  <div>
                    ...
                    <div className='overflow-hidden rounded-xl border border-border'>
                      ...
                      {payroll.components.map((comp) => (
                        ...
                        >
                          <div>
                            <p className='text-sm font-medium text-foreground'>{comp.componentName}</p>
                            <Badge
                          ...
                          <p className={`text-sm font-semibold ${comp.componentType === 'earning' ? 'text-emerald-600' : 'text-rose-600'}`}>
                    ...
                    return (
                      ...
                      >
                        <div className='mb-3 flex items-start justify-between'>
                          <div>
                            <p className='text-sm font-semibold text-foreground'>{lb.leaveTypeName}</p>
                          ...
                          <div className='text-right'>
                            ...
                            <p className='text-xs text-muted-foreground'>dari {lb.totalBalance} hari</p>
                          </div>
                        </div>
                        {/* Progress bar */}
