// promotion-preview-view.tsx — Preview of the proposal (Image 1)
...
interface PromotionPreviewViewProps {
...
export function PromotionPreviewView({
  formData,
  employees,
  onEdit,
  onReview,
}: PromotionPreviewViewProps) {
