...
import { useGetPromotions, useCreatePromotion, useGetEmployees } from '@/features/employment/hooks'
import type { EmployeePromotion } from '@/features/employment/types'
import { AppMain } from '@/shared/components/app-layout/app-main'
import { PromotionTable } from '@/features/employment/components/promotion-table'
import type { PromotionAction } from '@/features/employment/components/promotion-table'
import { PromotionDetailView } from './promotion-detail-view'
import { PromotionCreateView } from './promotion-create-view'
import type { PromotionFormData } from './promotion-create-view'
...
export function EmploymentPromotionPage({
  ...
  // ─── Data ──────────────────────────────────────────────────────────────────
  const { data: promotions = [], isPending, isFetching, error, refetch } = useGetPromotions(
  ...
  if (activeView === 'detail') {
    ...
    breadcrumbs = [...breadcrumbs, { label: 'Create' }, { label: 'Preview' }, { to: '.', label: 'Review' }]
    actions = null
  } else if (activeView === 'review-existing') {
    title = 'Promotion · Review & Confirm'
    subtitle = 'Confirm new position and grade before submitting.'
    breadcrumbs = backToView === 'detail'
      ? [...breadcrumbs, { label: 'Detail' }, { label: 'Edit' }, { label: 'Preview' }, { to: '.', label: 'Review' }]
