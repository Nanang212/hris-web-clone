    ...
    <div className='flex flex-col gap-6'>
      <div className='rounded-2xl border border-border/60 bg-card shadow-sm overflow-hidden'>
        ...
        <div className='px-6 py-2'>
          ...
          <ReviewRow label='Reason' value={`${formData.resignationType} resignation · ${formData.reason}`} />
        ...
        {/* Warning notice */}
        <div className='mx-6 mb-6 mt-2 rounded-xl border border-rose-200 bg-rose-50/60 px-4 py-3 dark:border-rose-800/40 dark:bg-rose-950/20'>
          <p className='text-xs text-rose-700 dark:text-rose-300'>
            Submitting resignation schedules access revocation and marks the employee inactive after the last working date.
          </p>
        </div>
      </div>
