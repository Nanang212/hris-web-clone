// rotation-create-view.tsx — Form to create a new rotation request
...
interface RotationCreateViewProps {
  employees: Employee[]
  onCancel: () => void
  onReview: (formData: RotationFormData) => void
  isPending?: boolean
}
...
export function RotationCreateView({
  employees,
  onCancel,
  onReview,
  isPending = false,
}: RotationCreateViewProps) {
    ...
    <div className='flex flex-col gap-6'>
      ...
      <div className='grid grid-cols-1 gap-6 lg:grid-cols-2'>
        ...
        <div className='rounded-2xl border border-border/60 bg-muted/30 p-6 shadow-sm'>
          <h3 className='mb-4 text-sm font-bold text-foreground'>Current Assignment</h3>
          <div className='flex flex-col gap-3'>
            <FieldGroup>
              <Field label='Division'>
                <Input
                  value={selectedEmployee?.divisionName ?? '-'}
                  readOnly
        ...
        <div className='rounded-2xl border border-border/60 bg-card p-6 shadow-sm'>
          <h3 className='mb-4 text-sm font-bold text-foreground'>New Assignment</h3>
          <div className='flex flex-col gap-3'>
            <FieldGroup>
              <Field label='Division *'>
                <Input
