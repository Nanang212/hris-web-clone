...
/**
 * Endpoint: `/api/v1/employment/employee-profilermation/create-options`
 * Method: `GET`
...
export async function getEmployeeCreationOptions() {
  const res = await apiClient.get<Envelope<EmployeeCreationOptionsData>>(
    '/api/v1/employment/employee-profilermation/create-options',
  )
  return res.data
}

/**
 * Endpoint: `/api/v1/employment/employee-profilermation`
 * Method: `POST`
...
export async function createEmployeeInformation(request: CreateEmployeeInformationRequest) {
  ...
  const res = await apiClient.post<Envelope<CreateEmployeeInformationData>>(
    '/api/v1/employment/employee-profilermation',
    body,
  )
  return res.data
}
...
/**
 * Endpoint: `/api/v1/employment/employee-profilermation/{employeeId}`
 * Method: `GET`
...
export async function getEmployeeInformationDetail(employeeId: string) {
  const res = await apiClient.get<Envelope<EmployeeInformationDetailData>>(
    `/api/v1/employment/employee-profilermation/${employeeId}`,
  )
  return res.data
}
...
export async function updateEmployeeInformation(request: UpdateEmployeeInformationRequest) {
  ...
  const res = await apiClient.patch<Envelope<EmployeeInformationDetailData>>(
    `/api/v1/employment/employee-profilermation/${request.employeeId}`,
    body,
  )
  return res.data
}
...
/**
 * Endpoint: `/api/v1/employment/employee-profilermation/{employeeId}/bank-verification`
 * Method: `POST`
...
export async function requestEmployeeBankVerification(employeeId: string) {
  const res = await apiClient.post<Envelope<EmployeeBankVerificationData>>(
    `/api/v1/employment/employee-profilermation/${employeeId}/bank-verification`,
  )
  return res.data
}

/**
 * Endpoint: `/api/v1/employment/employee-profilermation/overview`
 * Method: `GET`
...
export async function getEmployeeInformationOverview() {
  const res = await apiClient.get<Envelope<EmployeeInformationOverviewData>>(
    '/api/v1/employment/employee-profilermation/overview',
  )
  return res.data
}
...
/**
 * Endpoint: `/api/v1/employment/employee-profilermation/import`
 * Method: `POST`
...
export async function importEmployeeInformation(file: File) {
  ...
  const res = await apiClient.post<Envelope<ImportEmployeeInformationData>>(
    '/api/v1/employment/employee-profilermation/import',
    body,
  )
  return res.data
}
...
/**
 * Endpoint: `/api/v1/employment/employee-profilermation/export`
 * Method: `GET`
 * Query params: same active filters as `GET /api/v1/employment/employee-profilermation`; optional `employeeIds` exports only the selected employees.
...
export async function exportEmployeeInformation(params?: EmployeeInformationFilterParams) {
  const res = await apiClient.get<Blob>('/api/v1/employment/employee-profilermation/export', {
    params,
    responseType: 'blob',
  })
  return res.data
...
/**
 * Endpoint: `/api/v1/employment/employee-profilermation/:id/status`
 * Method: `PATCH`
...
export async function updateEmployeeInformationStatus(
  ...
  const res = await apiClient.patch<Envelope<EmployeeInformationActionData>>(
    `/api/v1/employment/employee-profilermation/${id}/status`,
    payload,
  )
  return res.data
}
...
/**
 * Endpoint: `/api/v1/employment/employee-profilermation/:id/profile`
 * Method: `GET`
...
export async function downloadEmployeeProfile(id: string) {
  const res = await apiClient.get<Blob>(
    `/api/v1/employment/employee-profilermation/${id}/profile`,
    {
      responseType: 'blob',
    },
  )
...
/**
 * Endpoint: `/api/v1/employment/employee-profilermation/:id/archive`
 * Method: `POST`
...
export async function archiveEmployeeInformation(id: string) {
  const res = await apiClient.post<Envelope<EmployeeInformationActionData>>(
    `/api/v1/employment/employee-profilermation/${id}/archive`,
  )
  return res.data
}
