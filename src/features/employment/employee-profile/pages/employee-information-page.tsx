    ...
    <DropdownMenu>
      ...
      <DropdownMenuContent align='end'>
        <DropdownMenuItem asChild>
          <Link to='/employment/employee-profile/$employeeId' params={{ employeeId: employee.id }}>
            <IconEye />
      ...
      actions={
        <div className='flex flex-wrap justify-end gap-2'>
          <Button variant='outline' size='sm' asChild>
            <Link to='/employment/employee-profile/import'>
              <IconFileUpload data-icon='inline-start' />
              {m.employee_information_import()}
            </Link>
          </Button>
          <Button variant='outline' size='sm' asChild>
            <Link to='/employment/employee-profile/export'>
              <IconDownload data-icon='inline-start' />
              {m.employee_information_export()}
            </Link>
          </Button>
          <Button size='sm' asChild>
            <Link to='/employment/employee-profile/new'>
            ...
            <Card size='sm'>
              ...
              <CardFooter>
                <Button
                  ...
                  onClick={() => void navigate({ to: '/employment/employee-profile/new' })}
                >
