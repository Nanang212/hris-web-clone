...
export function EmployeeInformationDetailPage({
  ...
  return (
    <AppMain
      breadcrumbs={[
        { to: '/employment/employee-profile', label: m.app_layout_nav_employee_information() },
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align='end'>
              ...
              <DropdownMenuItem asChild>
                <Link to='/employment/employee-profile'>
                  <IconChevronLeft />
      ...
      <Tabs defaultValue='personal' className='min-w-0'>
        ...
        >
          ...
          <TabsTrigger value='bpjs'>
            {m.employee_information_detail_tab_bpjs
              ? m.employee_information_detail_tab_bpjs()
              : 'BPJS'}
          </TabsTrigger>
        </TabsList>
            ...
            <div className='flex min-w-0 flex-col gap-4'>
              <Card>
                ...
                <CardContent className='flex flex-wrap items-center justify-between gap-3'>
                  <div>
                    <Badge variant={getBankVerificationVariant(financial.bankVerification?.status)}>
                  ...
                  <Badge
                    variant={financial.bankVerification?.payrollMappingActive ? 'green' : 'slate'}
                  >
