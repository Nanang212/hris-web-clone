// src/features/employment/employee-profile/pages/export-employee-information-page.tsx
import { IconDownload, IconHistory, IconRefresh, IconShieldLock } from '@tabler/icons-react'
...
export function ExportEmployeeInformationPage() {
    ...
    setTimeout(() => {
      ...
      if (employmentType !== 'All Types') {
        filtered = filtered.filter(
          (e) => e.employmentType.toLowerCase() === employmentType.toLowerCase(),
        )
      }
  ...
  const renderCategoryCard = (title: string, category: ExportColumnDefinition['category']) => {
            ...
            <div className='grid gap-4 sm:grid-cols-2 lg:grid-cols-4'>
              <div className='flex flex-col gap-1.5'>
                ...
                <select
                  ...
                  className='flex h-9 w-full rounded-lg border border-input bg-background px-3 py-1 text-xs shadow-xs focus:ring-2 focus:ring-ring focus:outline-none'
                >
              ...
              >
                ...
                <div>
                  ...
                  <p className='text-[11px] text-muted-foreground'>
                    Standard formatted spreadsheet
                  </p>
                </div>
              </label>
            ...
            <CardContent className='flex flex-col gap-2.5'>
              ...
              >
                ...
                <div>
                  ...
                  <p className='text-[11px] text-muted-foreground'>
                    Deliver periodic report to email
                  </p>
                </div>
              </label>
            </CardContent>
            ...
            <div className='flex items-start gap-3'>
              ...
              <div className='flex flex-col gap-1'>
                ...
                <p className='text-xs text-blue-800/80 dark:text-blue-400/80'>
                  Exported data follows your organization's data privacy policies. Sensitive fields
                  are included based on your column selection and access level.
                </p>
              </div>
            </div>
          </Card>
