          ...
          >
            <FieldGroup className='grid gap-5 md:grid-cols-2 xl:grid-cols-3'>
              ...
              <EmployeeSelectField
                ...
                options={toSelectOptions(dummyEmployeeCreateOptions.sections)}
              />
              <EmployeeSelectField
      ...
      >
        {projects.fields.map((item, index) => (
          ...
          >
            <FieldGroup className='grid gap-5 md:grid-cols-2'>
              <EmployeeSelectField
                name={`projects.${index}.employeeId`}
                label={m.employee_information_create_employee_label()}
                options={[
                  {
              ...
              <EmployeeSelectField
                ...
                options={toSelectOptions(dummyEmployeeCreateOptions.projects)}
              />
              <EmployeeTextField
