...
import {
  ...
  useGetEmployees,
  useGetResignations,
} from '@/features/employment/resignation/hooks'
import type { EmployeeResignation } from '@/features/employment/resignation/types'
import {
  ResignationTable,
  type ResignationAction,
} from '@/features/employment/resignation/components/resignation-table'

import { ResignationCreateView, type ResignationFormData } from './resignation-create-view'
import { ResignationDetailView } from './resignation-detail-view'
import { ResignationReviewView } from './resignation-review-view'

type ActiveView = 'list' | 'detail' | 'create' | 'review-new' | 'review-existing'
  ...
  return (
    ...
    >
      ...
      {activeView === 'detail' && activeResignation && (
        <ResignationDetailView resignation={activeResignation} onReview={handleDetailReview} />
      )}
