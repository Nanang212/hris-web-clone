...
const DEFAULT_DOC_TEMPLATE: Array<
  Omit<
    EmployeeDocumentItem,
    'id' | 'fieldValue' | 'fileName' | 'fileSize' | 'status' | 'verifiedAt' | 'dueDate'
  >
> = [
...
let mockEmployeeCompleteness: EmployeeDocumentCompleteness[] = [
  {
    ...
    documents: [
      ...
      },
      {
        ...
        required: true,
        fieldLabel: 'BPJS No.',
        fieldValue: '98765432109',
        fileName: 'BPJS-KES_Rian.pdf',
        fileSize: '480 KB',
        status: 'verified',
        verifiedAt: '2023-01-21',
      },
      {
        id: 'd-1-5',
        key: 'bpjs_tk',
      ...
      },
      {
        ...
        fieldValue: 'S1 Teknik Informatika - ITB',
        fileName: 'Ijazah_Rian.pdf',
        fileSize: '2.1 MB',
        status: 'verified',
  ...
  },
  {
    ...
    documents: [
      ...
      },
      {
        ...
        required: true,
        fieldLabel: 'NPWP',
        fieldValue: '02.456.789.0-901.000',
        fileName: 'NPWP_Siti.pdf',
        fileSize: '560 KB',
        status: 'verified',
        verifiedAt: '2026-06-02',
      },
      {
        ...
        required: true,
        fieldLabel: 'BPJS No.',
        fieldValue: '66778899001',
        fileName: 'BPJS-KES_Siti.pdf',
        fileSize: '490 KB',
        status: 'verified',
      ...
      },
      {
        ...
        required: true,
        fieldLabel: 'Education',
        fieldValue: 'S1 Psikologi - Universitas Indonesia',
        fileName: 'Ijazah_Siti.pdf',
        fileSize: '1.8 MB',
        status: 'verified',
        verifiedAt: '2026-06-03',
      },
    ...
    documents: [
      {
        ...
        required: true,
        fieldLabel: 'NIK',
        fieldValue: '3174011223344556',
        fileName: 'KTP_Budi.pdf',
        fileSize: '1.1 MB',
        status: 'verified',
        verifiedAt: '2020-03-12',
      },
      {
        id: 'd-3-2',
        key: 'kk',
      ...
      },
      {
        ...
        required: true,
        fieldLabel: 'NPWP',
        fieldValue: '03.789.012.3-456.000',
        fileName: 'NPWP_Budi.pdf',
        fileSize: '610 KB',
        status: 'verified',
        verifiedAt: '2020-03-12',
      },
      ...
      },
      {
        ...
        required: true,
        fieldLabel: 'Education',
        fieldValue: 'S2 Computer Science - NUS',
        fileName: 'Ijazah_Budi.pdf',
        fileSize: '2.4 MB',
        status: 'verified',
        verifiedAt: '2020-03-15',
      },
    ],
  },
  {
    ...
    documents: [
      {
        ...
        required: true,
        fieldLabel: 'NIK',
        fieldValue: '3175023344556677',
        fileName: 'KTP_Dewi.pdf',
        fileSize: '1.3 MB',
        status: 'verified',
        verifiedAt: '2021-05-14',
      },
      {
        id: 'd-4-2',
        key: 'kk',
      ...
      },
      {
        ...
        required: true,
        fieldLabel: 'NPWP',
        fieldValue: '04.123.456.7-890.000',
        fileName: 'NPWP_Dewi.pdf',
        fileSize: '650 KB',
        status: 'verified',
        verifiedAt: '2021-05-14',
      },
      {
        ...
        required: true,
        fieldLabel: 'BPJS No.',
        fieldValue: '77889900112',
        fileName: 'BPJS-KES_Dewi.pdf',
        fileSize: '530 KB',
        status: 'verified',
        verifiedAt: '2021-05-15',
      },
      {
        id: 'd-4-5',
        key: 'bpjs_tk',
        ...
        required: true,
        fieldLabel: 'BPJS No.',
        fieldValue: '33445566778',
        fileName: 'BPJS-TK_Dewi.pdf',
        fileSize: '540 KB',
        status: 'verified',
        verifiedAt: '2021-05-15',
      },
      {
        ...
        required: true,
        fieldLabel: 'Education',
        fieldValue: 'S2 Manajemen SDM - UGM',
        fileName: 'Ijazah_Dewi.pdf',
        fileSize: '2.0 MB',
        status: 'verified',
        verifiedAt: '2021-05-16',
      },
    ],
  },
  {
    ...
    documents: [
      ...
      },
      {
        ...
        required: true,
        fieldLabel: 'No. KK',
        fieldValue: '3172037788990011',
        fileName: 'KK_Andi.pdf',
        fileSize: '780 KB',
        status: 'verified',
        verifiedAt: '2026-07-01',
      },
...
export const saveEmployeeDocuments = async (
  ...
  const completedCount = reqDocs.filter(
    (d) => d.status === 'verified' && Boolean(d.fileName),
  ).length
