...
import { IconChevronLeft, IconDownload, IconPlus } from '@tabler/icons-react'
...
import { downloadExcelExport } from '@/features/employment/document/lib/download-helper'
...
export function DocumentCenterPage({
  ...
  let subtitle =
    'Monitor employee document completeness, expiry, verification, and retention in one place.'
        ...
        >
          ...
          <div className='border-b border-border/60 pb-1'>
            <TabsList variant='line' className='gap-6'>
              <TabsTrigger value='overview' className='px-1 pb-3 text-xs font-semibold'>
                Overview
              </TabsTrigger>
              <TabsTrigger value='certificates' className='px-1 pb-3 text-xs font-semibold'>
                Certificates
              </TabsTrigger>
              <TabsTrigger value='attachments' className='px-1 pb-3 text-xs font-semibold'>
                Attachments
              </TabsTrigger>
            </TabsList>
          </div>
          ...
          <TabsContent value='overview'>
            <DocumentOverviewTab onManageEmployee={(emp) => handleOpenUpload(emp)} />
          </TabsContent>
