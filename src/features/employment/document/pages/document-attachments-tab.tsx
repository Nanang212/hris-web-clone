...
import { AttachmentDirectoryTable } from '@/features/employment/document/components/attachment-directory-table'
import {
  DocumentStatsCards,
...
import { useGetAttachments, useGetAttachmentStats } from '@/features/employment/document/hooks'
import {
  downloadExcelExport,
...
export function DocumentAttachmentsTab() {
  ...
  const handleExportZipBundle = async () => {
    ...
    try {
      ...
      snackbar.success(
        `Downloaded complete package: Excel + ${attachments.length} Supporting Files!`,
      )
    } catch {
  ...
  return (
    <div className='flex flex-col gap-6'>
      ...
      <UploadAttachmentModal open={isUploadOpen} onOpenChange={setIsUploadOpen} />
    </div>
  )
}
