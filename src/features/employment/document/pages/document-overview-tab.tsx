...
import { DocumentCompletenessTable } from '@/features/employment/document/components/document-completeness-table'
import { DocumentEmployeeSnapshot } from '@/features/employment/document/components/document-employee-snapshot'
import {
  DocumentStatsCards,
...
export function DocumentOverviewTab({ onManageEmployee }: DocumentOverviewTabProps) {
  ...
  const activeSelected =
    selectedItem && list.some((i) => i.id === selectedItem.id) ? selectedItem : (list[0] ?? null)
    ...
    <div className='flex flex-col gap-6'>
      ...
      <div className='grid grid-cols-1 gap-6 lg:grid-cols-3'>
        ...
        <div className='lg:col-span-1'>
          <DocumentEmployeeSnapshot selected={activeSelected} onManage={onManageEmployee} />
        </div>
      </div>
    </div>
  )
