...
export function CreateContractPage() {
  ...
  const onSubmit = (values: FormValues) => {
    ...
    navigate({ to: '/employment/contract' })
  }
  ...
  return (
    <AppMain
      breadcrumbs={[
        { to: '/', label: 'Company' },
        { to: '/employment/contract', label: 'Contract' },
        { to: '.', label: 'Create' },
      ]}
        ...
        <div className='flex flex-col gap-6'>
          ...
          <Card className='border-border/50 shadow-sm'>
            <CardContent className='flex items-center justify-between pt-6'>
              ...
              <Badge variant='gray' className='px-3 py-1 text-xs font-semibold'>
                Draft
              </Badge>
            </CardContent>
          </Card>
          ...
          <Card className='border-border/50 shadow-sm'>
            ...
            <CardContent className='pt-6'>
              <FieldGroup>
                <div className='grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3'>
                  ...
                  <Field data-invalid={!!errors.contractNumber}>
                    ...
                    />
                    <FieldError
                      errors={errors.contractNumber ? [errors.contractNumber] : undefined}
                    />
                  </Field>
              ...
              {/* Informational Alert */}
              <div className='mt-6 rounded-xl border border-blue-100 bg-blue-50/50 p-4 text-xs text-blue-700 dark:border-blue-900/50 dark:bg-blue-950/20 dark:text-blue-300'>
                Contract template and employee details will be merged into the final document after
                approval.
              </div>
            </CardContent>
          </Card>
          ...
          <Card className='border-border/50 shadow-sm'>
            <CardContent className='flex items-center justify-between pt-6'>
              ...
              <Button
                type='button'
                variant='outline'
                className='h-9 border-2 border-dashed text-xs hover:bg-muted'
