...
export function EmployeeTable({
  ...
  const paginatedEmployees = employees.slice((activePage - 1) * pageSize, activePage * pageSize)
            ...
            return (
              ...
              >
                ...
                <TableCell className='text-right'>
                  {isSelected ? (
                    <div className='inline-flex size-6 items-center justify-center rounded-full bg-primary/10 text-primary'>
                      <IconCheck size={14} />
                    </div>
                  ) : (
                    <Button
