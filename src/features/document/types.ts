...
export type DocumentVerificationStatus = 'verified' | 'valid' | 'missing' | 'expiring' | 'expired' | 'pending'
...
export type AttachmentCategory = 'Recruitment' | 'Training' | 'Medical' | 'Recognition' | 'Other' | (string & {})
