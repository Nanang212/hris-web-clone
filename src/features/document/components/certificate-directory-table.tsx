                ...
                <TableRow key={cert.id} className='hover:bg-muted/30 transition-colors'>
                  <TableCell>
                    <div className='flex items-center gap-3'>
                      ...
                      <div className='min-w-0'>
                        <p className='text-xs font-semibold text-foreground truncate'>{cert.fullName}</p>
                        <p className='text-[11px] text-muted-foreground truncate'>{cert.employeeCode} · {cert.department}</p>
                      </div>
                    </div>
                  </TableCell>
                  ...
                  <TableCell>
                    <div className='flex items-center gap-2'>
                      <IconAward size={15} className='text-primary flex-shrink-0' />
                      <span className='text-xs font-semibold text-foreground truncate'>{cert.title}</span>
                    </div>
                  </TableCell>

                  <TableCell className='text-xs font-medium text-foreground/80'>{cert.issuer}</TableCell>
