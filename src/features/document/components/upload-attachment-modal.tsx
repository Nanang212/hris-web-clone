...
import type { AttachmentCategory, AttachmentItem } from '@/features/document/types'
        ...
        <form onSubmit={handleSubmit} className='space-y-4 py-2 text-xs'>
          ...
          <div className='space-y-1.5'>
            ...
            <select
              ...
              disabled={isEditMode}
              className={`h-9 w-full rounded-lg border border-border bg-background px-3 text-xs text-foreground focus:outline-none focus:ring-2 focus:ring-primary/30 ${isEditMode ? 'opacity-70 cursor-not-allowed' : ''}`}
            >
              {employees.map((emp) => (
          ...
          <div className='space-y-1.5'>
            ...
            <select
              ...
              className='h-9 w-full rounded-lg border border-border bg-background px-3 text-xs text-foreground focus:outline-none focus:ring-2 focus:ring-primary/30'
            >
          ...
          {category === 'Other' && (
            <div className='space-y-1.5 rounded-xl border border-primary/20 bg-primary/5 p-3 animate-in fade-in-50 duration-200'>
              <label className='font-semibold text-foreground'>
          ...
          <div className='space-y-1.5'>
            ...
            <div className='flex items-center gap-2'>
              <label className='flex h-9 cursor-pointer items-center justify-center rounded-lg border border-dashed border-border px-3 text-xs font-semibold hover:bg-muted/40 transition-colors'>
              ...
              <span className='text-[11px] text-muted-foreground truncate max-w-[240px]'>
                {fileName ? `${fileName} (${fileSize})` : 'No file chosen (PDF, DOC, XLS up to 10MB)'}
              </span>
            </div>
          </div>
