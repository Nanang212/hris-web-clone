...
import type { CertificateItem } from '@/features/document/types'
        ...
        <form onSubmit={handleSubmit} className='space-y-4 py-2 text-xs'>
          ...
          <div className='space-y-3 rounded-xl border border-border/60 bg-muted/20 p-3'>
            <div className='grid grid-cols-2 gap-3'>
              ...
              <div className='space-y-1.5'>
                <label className={`font-semibold ${hasNoExpiry ? 'text-muted-foreground' : 'text-foreground'}`}>
                ...
                <Input
                  ...
                  className={`h-9 text-xs bg-background ${hasNoExpiry ? 'opacity-50 cursor-not-allowed' : ''}`}
