  ...
  'group/tabs-list inline-flex w-fit items-center justify-center text-muted-foreground group-data-horizontal/tabs:h-9 group-data-vertical/tabs:h-fit group-data-vertical/tabs:flex-col',
  {
    variants: {
      variant: {
        ...
        segmented:
          'no-scrollbar max-w-full flex-nowrap gap-1 overflow-x-auto rounded-2xl border border-border/50 bg-card p-2 shadow-sm group-data-horizontal/tabs:h-auto group-data-vertical/tabs:rounded-2xl',
      },
    },
    defaultVariants: {
      variant: 'default',
