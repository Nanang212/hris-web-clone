...
function PopupCloseButton({ onClick }: { onClick: () => void }) {
  return (
    <button
      ...
      className='absolute inset-e-1 top-1 z-10 inline-flex size-5 cursor-pointer items-center justify-center rounded-sm text-foreground transition-colors hover:bg-muted focus:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-inset'
    >
...
function MarkerLabel({ children, className, position = 'top' }: Readonly<MarkerLabelProps>) {
  ...
  return (
    <div
      className={cn(
        'absolute inset-s-1/2 -translate-x-1/2 whitespace-nowrap rtl:translate-x-1/2',
