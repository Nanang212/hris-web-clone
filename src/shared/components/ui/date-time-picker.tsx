...
import type { TEventFormData } from '@/shared/components/calendar/schemas'
...
export function DateTimePicker({ form, field }: DatePickerProps) {
  ...
  return (
    <Field className='flex flex-col' data-invalid={!!error}>
      <FieldLabel>{field.name === 'startDate' ? 'Start Date' : 'End Date'}</FieldLabel>
      <Popover modal={true}>
