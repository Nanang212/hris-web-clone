...
import { DayPicker } from "@/shared/components/ui/day-picker";
...
import { groupEvents } from "@/shared/components/calendar/helpers";
import type { IEvent } from "@/shared/components/calendar/interfaces";
import { CalendarTimeline } from "@/shared/components/calendar/calendar-time-line";
import { DayViewMultiDayEventsRow } from "@/shared/components/calendar/day-view-multi-day-events-row";
import { RenderGroupedEvents } from "@/shared/components/calendar/render-grouped-events";
...
export function CalendarDayView({ singleDayEvents, multiDayEvents }: IProps) {
  ...
  return (
    <div className="flex">
      <div className="flex flex-1 flex-col">
        <div>
          ...
          <div className="relative z-20 flex border-b">
            ...
            <span className="flex-1 border-s py-2 text-center text-xs font-medium text-t-quaternary">
        ...
        <ScrollArea className="h-[800px]" type="always" ref={scrollAreaRef}>
          <div className="flex">
            ...
            {/* Day grid */}
            <div className="relative flex-1 border-s">
      ...
      <div className="hidden w-72 divide-y border-s md:block">
        <DayPicker
