    ...
    >
      ...
      {isResizing && resizePreview && (
        <motion.div
          ...
          exit={{ opacity: 0, y: -10 }}
          className="absolute -top-8 start-1/2 transform -translate-x-1/2 rtl:translate-x-1/2 bg-gray-900 text-white text-xs px-2 py-1 rounded shadow-lg z-50 whitespace-nowrap"
        >
